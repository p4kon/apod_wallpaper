...
internal static class AppStrings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Downloaded images"] = "Скачанные изображения",
        ...
        ["Fill"] = "Заполнить",
        ["Fit"] = "По размеру",
        ["Folder path is not available."] = "Путь к папке недоступен.",
        ["Fri"] = "Пт",
        ["French"] = "Французский",
        ...
        ["Into deep space"] = "В дальний космос",
        ...
        ["Later"] = "Позже",
        ["Library"] = "Библиотека",
        ["Library summary loaded"] = "Сводка библиотеки загружена",
        ["Library summary unavailable"] = "Сводка библиотеки недоступна",
        ...
        ["Loading library summary"] = "Загрузка сводки библиотеки",
        ...
        ["Month"] = "Месяц",
        ["Month calendar"] = "Календарь месяца",
        ["NASA"] = "NASA",
        ...
        ["No APOD images are available for this random source."] = "Для этого источника нет изображений APOD.",
        ["No favorite images yet"] = "Избранных изображений пока нет",
        ["No files were changed."] = "Файлы не изменялись.",
        ...
        ["Could not find an available APOD date quickly."] = "Не удалось быстро найти доступную дату APOD.",
        ...
        ["Pick a random APOD date"] = "Выбрать случайную дату APOD",
        ["Ready"] = "Готово",
        ["Random"] = "Случайно",
        ["Random APOD preference saved."] = "Настройка случайного APOD сохранена.",
        ["Random APOD date range is empty."] = "Диапазон дат случайного APOD пуст.",
        ["Random APOD selected"] = "Случайный APOD выбран",
        ["Random APOD unavailable"] = "Случайный APOD недоступен",
        ["Random source"] = "Источник случайного APOD",
        ["Refresh"] = "Обновить",
        ...
        ["Review local APOD storage without deleting files."] = "Просматривайте локальное хранилище APOD без удаления файлов.",
        ["Russian"] = "Русский",
        ...
        ["Checking a random APOD date."] = "Проверяем случайную дату APOD.",
        ["Smart variants"] = "Smart-варианты",
        ["Span"] = "На все экраны",
        ["Spanish"] = "Испанский",
        ...
        ["Unable to pick a random APOD date."] = "Не удалось выбрать случайную дату APOD.",
        ["Unable to load library summary."] = "Не удалось загрузить сводку библиотеки.",
        ...
        ["Unable to open data folder"] = "Не удалось открыть папку данных",
        ["Unable to open folder"] = "Не удалось открыть папку",
        ["Unable to open images folder"] = "Не удалось открыть папку изображений",
        ...
        ["Unable to summarize the local APOD library."] = "Не удалось собрать сводку локальной библиотеки APOD.",
        ["Unknown"] = "Неизвестно",
        ...
        ["Use APOD full archive from 1995. Some early dates may be unavailable."] = "Использовать полный архив APOD с 1995 года. Некоторые ранние даты могут быть недоступны.",
        ...
        ["Wed"] = "Ср",
        ["Windows did not open the folder."] = "Windows не открыла папку.",
        ["Windows did not open the images folder."] = "Windows не открыла папку изображений.",
        ["Year"] = "Год",
        ["Year overview"] = "Обзор года",
        ["Year overview loaded"] = "Обзор года загружен",
        ["Year view uses cached local calendar knowledge only."] = "Годовой вид использует только локально кэшированные данные календаря.",
        ["Loading year overview"] = "Загрузка обзора года",
        ["Rendering the cached year overview without refreshing NASA state."] = "Показываем кэшированный обзор года без обновления состояния NASA.",
        ["Calendar year failed"] = "Ошибка календарного года",
        ["Unable to build calendar year state."] = "Не удалось построить состояние календарного года.",
        ["You are running version {0}."] = "Установлена версия {0}.",
        ["Opened random APOD for {0}."] = "Открыт случайный APOD за {0}.",
