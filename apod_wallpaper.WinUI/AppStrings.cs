...
internal static class AppStrings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["APOD Wallpaper is up to date"] = "APOD Wallpaper обновлен",
        ["APOD Wallpaper is up to date."] = "APOD Wallpaper обновлен.",
        ["APOD Wallpaper will open the GitHub release page. It will not install updates automatically."] = "APOD Wallpaper откроет страницу релиза GitHub. Обновления не устанавливаются автоматически.",
        ["A newer APOD Wallpaper release is available."] = "Доступен новый релиз APOD Wallpaper.",
        ["Auto"] = "Авто",
        ["Auto Off"] = "Авто выкл.",
        ["Auto On"] = "Авто вкл.",
        ["Auto-check preference saved."] = "Настройка автопроверки сохранена.",
        ["Auto-check for updates"] = "Автопроверка обновлений",
        ...
        ["Checking GitHub Releases for the latest APOD Wallpaper version."] = "Проверяем последнюю версию APOD Wallpaper в GitHub Releases.",
        ["Check GitHub Releases once per day and notify when a new version is available."] = "Проверять GitHub Releases раз в сутки и уведомлять, когда доступна новая версия.",
        ...
        ["Choose what automatic wallpaper rotation applies."] = "Выберите, что применяет автоматическая ротация обоев.",
        ...
        ["GitHub did not return latest release information."] = "GitHub не вернул информацию о последнем релизе.",
        ["GitHub latest release response was empty."] = "Ответ GitHub о последнем релизе был пустым.",
        ...
        ["Unable to check GitHub releases for updates."] = "Не удалось проверить обновления через GitHub Releases.",
        ...
        ["Update check preference saved."] = "Настройка проверки обновлений сохранена.",
        ["Update check was already completed today."] = "Проверка обновлений уже выполнялась сегодня.",
        ["Automatic update checks are disabled."] = "Автоматическая проверка обновлений отключена.",
        ...
        ["Wallpaper source"] = "Источник обоев",
        ["Wallpaper source preference saved."] = "Настройка источника обоев сохранена.",
        ...
        ["You are running version {0}."] = "Установлена версия {0}.",
