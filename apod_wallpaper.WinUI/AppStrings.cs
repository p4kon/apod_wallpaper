...
internal static class AppStrings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Translate"] = "Перевести",
        ["TranslationTargetDisplayDe"] = "de",
        ["TranslationTargetDisplayEs"] = "es",
        ["TranslationTargetDisplayFr"] = "fr",
        ["TranslationTargetDisplayIt"] = "it",
        ["TranslationTargetDisplayJa"] = "日",
        ["TranslationTargetDisplayPt"] = "pt",
        ["TranslationTargetDisplayRu"] = "ру",
