...
internal static class AppStrings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Apply"] = "Установить",
        ["Apply latest"] = "Установить последнюю",
        ["Apply latest APOD"] = "Установить последний APOD",
        ...
        ["Auto-check today's APOD"] = "Автопроверка APOD за сегодня",
        ...
        ["Choose what happens when you click the window close button."] = "Что делать при нажатии на крестик окна.",
        ["Close behavior"] = "Поведение крестика",
        ["Configure"] = "Настроить",
        ...
        ["Use Download, Download and apply, or Apply latest. Wallpaper style changes are saved through the backend and can reapply the current image."] = "Используйте Скачать, Установить или автообновление. Режим обоев сохраняется через backend и может переустановить текущее изображение.",
